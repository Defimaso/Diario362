...
const MILESTONE_DEFINITIONS = [
  { type: 'first_checkin', label: 'Primo Check-in', description: 'Hai completato il tuo primo check-in', emoji: '🎯', sort_order: 1 },
  { type: 'streak_3', label: '3 Giorni di Fila', description: '3 check-in consecutivi', emoji: '🔥', sort_order: 2 },
  { type: 'streak_7', label: 'Settimana Perfetta', description: '7 check-in consecutivi', emoji: '⭐', sort_order: 3 },
  { type: 'streak_14', label: 'Due Settimane', description: '14 check-in consecutivi', emoji: '💪', sort_order: 4 },
  { type: 'streak_30', label: 'Un Mese', description: '30 check-in consecutivi', emoji: '🏆', sort_order: 5 },
  { type: 'streak_60', label: 'Due Mesi', description: '60 check-in consecutivi', emoji: '💎', sort_order: 6 },
  { type: 'streak_90', label: 'Tre Mesi', description: '90 check-in consecutivi', emoji: '👑', sort_order: 7 },
  { type: 'total_10', label: '10 Check-in', description: 'Hai totalizzato 10 check-in', emoji: '📊', sort_order: 8 },
  { type: 'total_50', label: '50 Check-in', description: 'Hai totalizzato 50 check-in', emoji: '🚀', sort_order: 9 },
  { type: 'total_100', label: '100 Check-in', description: 'Hai totalizzato 100 check-in', emoji: '🌟', sort_order: 10 },
